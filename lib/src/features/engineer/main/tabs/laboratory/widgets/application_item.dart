...
class ApplicationItem extends StatefulWidget {
  ...
  @override
  State<ApplicationItem> createState() => _MenuItemState();
}

class _MenuItemState extends State<ApplicationItem>
    ...
    return GestureDetector(
      ...
      child: Transform.scale(
        ...
        child: AppContainer(
          ...
          child: Text(
            widget.model?.hetObjectPropertyName??'-',
            style: Theme
                .of(context)
                .textTheme
                .titleMedium,
        ...
        AppDivider(),
        RowTexts(text1: S.of(context).typeApplication, text2: widget.model?.type ?? '-'),
