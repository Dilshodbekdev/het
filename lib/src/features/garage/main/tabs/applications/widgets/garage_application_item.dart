...
class GarageApplicationItem extends StatefulWidget {
  final EngineerTransportApplication? model;
  final VoidCallback onClick;

  const GarageApplicationItem({
    super.key,
    required this.model,
  ...
  @override
  State<GarageApplicationItem> createState() => _MenuItemState();
}

class _MenuItemState extends State<GarageApplicationItem>
            ...
            child: Column(
              ...
              children: [
                ...
                RowTexts(
                    ...
                    text2: widget.model?.creatorHetObjectName ?? '-'),
                RowTexts(
                    text1: S.of(context).whenNeed,
                    text2: DateFormat("dd.MM.yyyy, HH:mm").format(DateTime.parse(widget.model?.whenNeed ?? ''))),
                Row(
